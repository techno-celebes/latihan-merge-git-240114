...
<section>
    <div class="container-fluid vh-100 mt-5">
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-md-9 col-lg-6 col-xl-5" data-aos="fade-right" data-aos-duration="3000">
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                <form>
                    ...
                    <div class="divider d-flex align-items-center my-4" data-aos="fade-right" data-aos-duration="3000">
                        <p class="text-center fw-bold mx-3 mb-0">Or</p>
                    </div>

                    <!-- Email input -->
                    <div class="form-outline mb-4" data-aos="fade-right" data-aos-duration="3000">
                        <input type="email" id="form3Example3" class="form-control form-control-lg" placeholder="Enter a valid email address" />
                        <label class="form-label" for="form3Example3">Email address</label>
                    </div>

                    <!-- Password input -->
                    <div class="form-outline mb-3" data-aos="fade-right" data-aos-duration="3000">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <!-- Checkbox -->
                        <div class="form-check mb-0" data-aos="fade-right" data-aos-duration="3000">
                            <input class="form-check-input me-2" type="checkbox" value="" id="form2Example3" />
                            <label class="form-check-label" for="form2Example3">
                                Remember me
                            </label>
                        </div>
                        <a href="#!" class="text-body" data-aos="fade-right" data-aos-duration="3000">Forgot password?</a>
                    </div>

                    <div class="text-center text-lg-start mt-4 pt-2" data-aos="fade-right" data-aos-duration="3000">
